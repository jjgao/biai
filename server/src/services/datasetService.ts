...
export class DatasetService {
  ...
  async updateColumnMetadata(
    ...
    const updatedColumn = {
      ...
      temporal_role: updates.temporalRole !== undefined ? updates.temporalRole : existingColumn.temporal_role,
      temporal_paired_column: updates.temporalPairedColumn !== undefined ? updates.temporalPairedColumn : existingColumn.temporal_paired_column,
      temporal_unit: updates.temporalUnit !== undefined ? updates.temporalUnit : existingColumn.temporal_unit
    }
