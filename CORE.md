# CORE.md - Shared Project Instructions

This file contains the shared project rules and reference material for all agents. Agent-specific files should defer to this file and only add unique guidance.
...
2. **Update Documentation**
   ...
   - Update agent instruction files (CLAUDE.md, GEMINI.md, AGENT.md) if adding patterns or conventions
...
## Workflow Patterns for Requests
...
```
- Use your tools to explore the codebase and answer questions.
