# GEMINI.md - Project Instructions for Gemini Code
...
2. **Update Documentation**
   ...
   - Update GEMINI.md if adding patterns or conventions
...
```
- Use my tools to explore the codebase and answer questions.
